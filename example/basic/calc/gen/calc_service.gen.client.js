...
//
//   Timestamp: Sat, 05 Jul 2025 14:38:24 EDT
...
class CalculatorServiceClient {
  ...
  _authorization;
  /** @type { calc~CalculatorServiceMiddleware } */
  _middleware;
   ...
   * @param { calc~CalculatorServiceMiddleware } [options.middleware] A handler function that lets you perform tasks
  ...
  constructor(baseURL, {fetch, authorization, middleware} = {}) {
    ...
    this._middleware = middleware || ((url, options, next) => { console.info(">>> Default middleware: " + url); return next(url, options);});
  }
  
  /**
   * Add calculates and returns the sum of two numbers. 
   *
   * @param { calc~AddRequest } serviceRequest The input parameters
   * @param {object} [options]
   ...
   * @returns {Promise<calc~AddResponse> } The JSON-encoded return value of the operation.
   */
   ...
   *
   * @param { calc~DoubleRequest } serviceRequest The input parameters
   * @param {object} [options]
   * @param { string } [options.authorization] The HTTP Authorization header value to include
   *     in the request. This will override any authorization you might have applied when
   *     constructing this client. Use this in multi-tenant situations where multiple users
   *     might utilize this service.
   * @returns {Promise<calc~DoubleResponse> } The JSON-encoded return value of the operation.
   */
   ...
   *
   * @param { calc~MulRequest } serviceRequest The input parameters
   * @param {object} [options]
   * @param { string } [options.authorization] The HTTP Authorization header value to include
   *     in the request. This will override any authorization you might have applied when
   *     constructing this client. Use this in multi-tenant situations where multiple users
   *     might utilize this service.
   * @returns {Promise<calc~MulResponse> } The JSON-encoded return value of the operation.
   */
   ...
   *
   * @param { calc~SubRequest } serviceRequest The input parameters
   * @param {object} [options]
   * @param { string } [options.authorization] The HTTP Authorization header value to include
   *     in the request. This will override any authorization you might have applied when
   *     constructing this client. Use this in multi-tenant situations where multiple users
   *     might utilize this service.
   * @returns {Promise<calc~SubResponse> } The JSON-encoded return value of the operation.
   */
...
/**
 * @typedef { object } calc~SubRequest
 * 
 * @property { number|* } [A]
 * @property { number|* } [B]
*/
/**
 * @typedef { object } calc~MulRequest
 * 
 * @property { number|* } [A]
 * @property { number|* } [B]
*/
/**
 * @typedef { object } calc~SubResponse
 * 
 * @property { number|* } [Value]
*/
/**
 * @typedef { object } calc~MulResponse
 * 
 * @property { number|* } [Value]
*/
/**
 * @typedef { object } calc~DoubleRequest
 * 
 * @property { number|* } [Value]
*/
/**
 * @typedef { object } calc~DoubleResponse
 * 
 * @property { number|* } [Value]
*/
/**
 * @typedef { object } calc~AddRequest
 * 
 * @property { number|* } [A]
 * @property { number|* } [B]
*/
/**
 * @typedef { object } calc~AddResponse
 * 
 * @property { number|* } [Value]
*/
...
/**
 * @callback calc~CalculatorServiceMiddleware
...
export { CalculatorServiceClient };
